    ...
    <main id="main-content">
      ...
      <div className="container max-w-3xl py-8 md:py-12">
        ...
        <div className="space-y-6 text-muted-foreground leading-relaxed">
          ...
          <FadeIn>
            <h2 className="font-serif text-2xl font-bold text-foreground pt-4">1. Informacioni që mbledhim</h2>
            <p>
          ...
          <FadeIn>
            <h2 className="font-serif text-2xl font-bold text-foreground pt-4">2. Si e përdorim informacionin</h2>
          ...
          <FadeIn>
            <h2 className="font-serif text-2xl font-bold text-foreground pt-4">3. Cookies</h2>
            <p>
          ...
          <FadeIn>
            <h2 className="font-serif text-2xl font-bold text-foreground pt-4">4. Ndarja e të dhënave</h2>
            <p>
          ...
          <FadeIn>
            <h2 className="font-serif text-2xl font-bold text-foreground pt-4">5. Të drejtat tuaja</h2>
            <p>
          ...
          <FadeIn>
            <h2 className="font-serif text-2xl font-bold text-foreground pt-4">6. Lidhjet e jashtme</h2>
            <p>
          ...
          <FadeIn>
            <h2 className="font-serif text-2xl font-bold text-foreground pt-4">7. Ndryshimet</h2>
            <p>
          ...
          <FadeIn>
            <h2 className="font-serif text-2xl font-bold text-foreground pt-4">8. Kontakti</h2>
            <p>
